...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{uncurryCell}\;\Varid{f}\;(\Varid{e},(\Varid{n1},\Varid{n2}))\mathrel{=}\Varid{f}\;\Varid{e}\;\Varid{n1}\;\Varid{n2}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{uncurryBlock}\;\Varid{f}\;(\Varid{q1},(\Varid{q2},(\Varid{q3},\Varid{q4})))\mathrel{=}\Varid{f}\;\Varid{q1}\;\Varid{q2}\;\Varid{q3}\;\Varid{q4}{}\<[E]%
\\[\blanklineskip]%
...
\begin{enumerate}
\item Descobrir \ensuremath{\Varid{o}}:
...
\just\equiv{ CENAS 73 }
%
    \ensuremath{\begin{lcbr}\Varid{f}\;\Varid{k}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{f}\;\Varid{k}\comp \Conid{TODO}\mathrel{=}\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
%
\just\equiv{ Eq + : (27) ; Natural id : (1) }
%
\ensuremath{\alt{\Varid{f}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{f}\;\Varid{k}\comp \Conid{TODO}}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
%
\just\equiv{ Fusão + : (20) ; Absorção x : (11) }
%
\ensuremath{\Varid{f}\;\Varid{k}\comp \alt{\underline{\mathrm{0}}}{\Conid{TODO}}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})}
%
\just\equiv{ Definição in naturais ; Definição Functor dos naturais \ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
%
...
\item Descobrir \ensuremath{\Varid{p}}:
\begin{eqnarray*}
\start
...
\just\equiv{ CENAS 73 }
%
    \ensuremath{\begin{lcbr}\Varid{l}\;\Varid{k}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{l}\;\Varid{k}\comp \Conid{TODO}\mathrel{=}\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
%
\just\equiv{ Eq + : (27) ; Natural id : (1) }
%
\ensuremath{\alt{\Varid{l}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{l}\;\Varid{k}\comp \Conid{TODO}}\mathrel{=}\alt{\Conid{TODO}\comp \Varid{k}}{\Conid{TODO}\comp \Varid{l}\;\Varid{k}}}
%
\just\equiv{ Natural id : (1) ; Cancelamento x : (7) }
%
\ensuremath{\alt{\Varid{l}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{l}\;\Varid{k}\comp \Conid{TODO}}\mathrel{=}\alt{\Conid{TODO}\comp \Varid{k}\comp \Varid{id}}{\Conid{TODO}\comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
%
\just\equiv{ Fusão + : (20) ; Absorção x : (11) }
%
\ensuremath{\Varid{l}\;\Varid{k}\comp \alt{\underline{\mathrm{0}}}{\Conid{TODO}}\mathrel{=}\alt{\Conid{TODO}\comp \Varid{k}}{\Conid{TODO}\comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})}
%
\just\equiv{ Definição naturais: \ensuremath{\mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\Conid{TODO}}} ; \ensuremath{\Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}(\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})} }
%
\ensuremath{\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\Conid{TODO}\comp \Varid{k}}{\Conid{TODO}\comp \p2}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}
%
\end{eqnarray*}

Logo, \ensuremath{\Varid{p}\mathrel{=}\alt{\Conid{TODO}\comp \Varid{k}}{\Conid{TODO}\comp \p2}}.
...
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;{}\<[13]%
\>[13]{}\Varid{mapFst}\;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{f}\;\Varid{a},\Varid{b}){}\<[E]%
\\
\>[13]{}\Varid{sums}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu];{}\<[E]%
\\
\>[13]{}\Varid{sums}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{a},\Varid{sum}\;\Varid{b})\mathbin{:}\Varid{sums}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
