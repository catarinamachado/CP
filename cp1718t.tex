...
%
\ensuremath{\Varid{base}\;\Varid{k}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\underline{(\succ \;\Varid{k})}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))}
%
\just\equiv{ Def split : (78) }
%
\ensuremath{\Varid{base}\;\Varid{k}\mathrel{=}(\conj{\underline{\mathrm{1}}}{\underline{(\succ \;\Varid{k})}}\;(\Varid{a},\Varid{b}),\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}\;(\Varid{c},\Varid{d}))}
%
\just\equiv{ Def split : (78) x2 }
%
\ensuremath{\Varid{base}\;\Varid{k}\mathrel{=}((\underline{\mathrm{1}}\;\Varid{a},\underline{(\succ \;\Varid{k})}\;\Varid{b}),(\underline{\mathrm{1}}\;\Varid{c},\underline{\mathrm{1}}\;\Varid{d}))}
%
...
Vemos que em \ensuremath{\mathbf{let}\;(\Varid{a},\anonymous ,\Varid{b},\anonymous )} que os tipos de \ensuremath{\Varid{loop}} e \ensuremath{\Varid{base}\;\Varid{k}}, mais especificamente
o tipo de retorno, terão que ser um quádruplo uma vez que o \ensuremath{\mathsf{for}\ \cdot \ \cdot } deverá retornar
também um quádruplo.
