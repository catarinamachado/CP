...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
>>>>>>> e9aff18805d64ebe3f0e3e4181a251db5abad508
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{a}\mathrel{=}\Varid{anaQTree}\;((\Varid{compress}\;\Varid{n})\comp \Varid{outQTree})\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{compress}\;\Varid{n}\;\Varid{a}\mid (\Varid{n}\equiv (\Varid{tam}\;\Varid{a})\mathrel{\vee}\Varid{n}\mathbin{>}(\Varid{tam}\;\Varid{a}))\mathrel{=}\Varid{outQTree}\;(\Varid{corta}\;(\Varid{inQTree}\;\Varid{a})){}\<[E]%
\\
\>[5]{}\hsindent{19}{}\<[24]%
\>[24]{}\mid \Varid{otherwise}\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{tam}\;\Varid{a}\mathrel{=}\Varid{depthQTree}\;(\Varid{inQTree}\;\Varid{a}){}\<[E]%
\\[\blanklineskip]%
