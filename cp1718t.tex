...
O gene \ensuremath{\Varid{g}\mathrel{=}\Varid{inFTree}\comp \Varid{baseFTree}\;\Varid{f}\;\Varid{h}\;\Varid{id}} do cataFTree pode ser demonstrado
...
tipos do gene do \ensuremath{\Varid{anaFTree}}:
\begin{eqnarray*}
\start
...
irá obter então o resultado \ensuremath{\Conid{Square}\times(\N_0\times\N_0)}. Para cada um dos \ensuremath{\N_0},
...
O objetivo de \ensuremath{\Varid{drawPTree}} animar incrementalmente os passos de construção de
